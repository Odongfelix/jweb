 ...
 */
export class EntriesDataSource implements DataSource<any> {
  ...
  getJournalEntries(filterBy: any, orderBy: string = '', sortOrder: string = '', pageIndex: number = 0, limit: number = 10) {
    ...
    this.mcurrencyService.getJournalEntries(filterBy, orderBy, sortOrder, pageIndex * limit, limit)
